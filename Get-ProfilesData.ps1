...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="User Profiles Collector" Height="205" Width="520"
...
'@
    ...
    # each status line renders - even while the MAIN thread is blocked for a long time enumerating a large
    # share. If the dedicated thread can't start we fall back to the inline splash, so collection is never
    # affected either way.
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <StackPanel Margin="24,20,24,20">
        <DockPanel Margin="0,0,0,16">
            ...
            <StackPanel>
                <TextBlock Text="User Profiles Collector" FontSize="16" FontWeight="Bold" Foreground="#0E7C86"/>
