...
$jsonPath   = Join-Path $OutputPath "$filePrefix-AVD-Data-$timestamp.json"   # extension set by Protect-CollectorOutput below
$json = $report | ConvertTo-Json -Depth 20
$prot     = Protect-CollectorOutput $json
$json     = $prot.Json
$jsonPath = [System.IO.Path]::ChangeExtension($jsonPath, $prot.Ext)
